...
\begin{figure}[H]
    \centering
    \begin{tabular}[b]{cc}
        \subcaptionbox{Original frame.}{\includegraphics[width=.8\textwidth]{figures/pictures/regular_right_96.jpeg}} \\
        \subcaptionbox{Original frame subtracted from decompressed frame.}{\includegraphics[width=.8\textwidth]{figures/pictures/aolp_right_96.jpeg}}
    \end{tabular}
