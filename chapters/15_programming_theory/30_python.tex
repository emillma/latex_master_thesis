...
To use \gls{asyncio}, the program must be written in a way that allows the event loop to switch between tasks, making it difficult to use with existing code.
