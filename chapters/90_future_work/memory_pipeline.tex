...
With \gls{pyds} is appears to be poosible to create \glspl{nvmmbuffer} using \code{NvBufSurfaceCreate} \cite{nvidiaNvBufSurfaceCreateDeepstreamDeepstream2023}\cite{babukrCreatingGstBuffersUsing2021}.
