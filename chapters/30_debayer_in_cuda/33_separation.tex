...
\begin{figure}[H]
    \centering
    \subcaptionbox{Synchronus}{\includegraphics[width=\textwidth]{figures/debayer/debayer_non_concurrent.pdf}}
    \subcaptionbox{Concurrent}{\includegraphics[width=\textwidth]{figures/debayer/debayer_concurrent.pdf}}
