...
To make the development process easier, the separate \code{pygobjcet-stubs} library, which provides type hints for \gls{pygo} is strongly recomended \cite{pygobjectTypingStubsPyGObject2023}.
