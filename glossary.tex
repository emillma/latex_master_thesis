...
% pygind11
\newglossaryentry{pybind11}{name=\code{pybind11},description={\todo}}
% async-dash
\newglossaryentry{async-dash}{name=\code{async-dash},description={\todo}}
% dashextensions
\newglossaryentry{dashextensions}{name=\code{dash-extensions},description={\todo}}
% pipeline
\newglossaryentry{pipeline}{name=pipeline,description={\todo}}
% chrome
\newglossaryentry{chrome}{name=Google Chrome,description={\todo}}
% j1
\newglossaryentry{j1}{name=Snapmaker J1,description={\todo}}
% --------------------
% ----- Acronyms -----
% --------------------
